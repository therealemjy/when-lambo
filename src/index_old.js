...
async function checkPair(args) {
  ...
  // const aaveResult = await aavePriceOrableContract.methods
  //   .getAssetPrice(outputTokenAddress)
  //   .call();
  ...
  console.table([
    {
      ...
      // "Aave Expected Rate": web3.utils.fromWei(
      //   kyberResult.expectedRate,
      //   "Ether"
      // ),
      // "Aave Min Return": web3.utils.fromWei(kyberResult.slippageRate, "Ether"),
      // Timestamp: moment().tz("Canada/Montreal").format(),
    },
  ]);
}

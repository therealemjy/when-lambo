...
interface IKyberNetworkProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class IKyberNetworkProxy extends BaseContract {
  ...
  functions: {
    getExpectedRate(
      ...
      [BigNumber, BigNumber] & { expectedRate: BigNumber; worstRate: BigNumber }
    >;

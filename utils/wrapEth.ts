...
const wrapEth = async (signer: Signer, ethAmount: BigNumber, toAddress: string) => {
  // Get contract
  const wethContract = new ethers.Contract(wethMainnetContractInfo.address, wethMainnetContractInfo.abi, signer);

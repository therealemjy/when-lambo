...
const sushiswapRouter_json_1 = __importDefault(require("./contracts/sushiswapRouter.json"));
class Sushiswap {
    constructor() {
        this.getDecimalAmountOutCallContext = ({ callReference, fromTokenDecimalAmounts, fromToken, toToken, }) => {
            ...
            return {
                context: {
                    ...
                    contractAddress: sushiswapRouter_json_1.default.address,
                    abi: sushiswapRouter_json_1.default.abi,
                    calls,
                },
        ...
        this.name = types_1.ExchangeName.Sushiswap;
    }
}
exports.default = Sushiswap;
